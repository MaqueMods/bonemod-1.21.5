...
public class ModItems {
    public static final Item BONE_SHARD = registerItem("bone_shard", new Item(new Item.Settings()));
    public static final Item BONE_TOMAHAWK = registerItem("bone_tomahawk", new Item(new Item.Settings()));
